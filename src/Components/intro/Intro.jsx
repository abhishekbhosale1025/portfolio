    ...
    <div className="i" id="main">
      <div className="i-left">
        <div className="i-left-wrapper">
         ...
         <a href="https://drive.google.com/file/d/10hmZjj_8caclKCf4WEP0CoUM2mL9mTcA/view?usp=sharing"> <button style={{cursor:"pointer",background:"#4070f4",color:"white",border:"none"}} id="btnresume">Resume</button></a>
        </div>
      </div>
