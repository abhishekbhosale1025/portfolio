    ...
    <div className="i" id="main">
      <div className="i-left">
        <div className="i-left-wrapper">
         ...
         <a href="https://drive.google.com/file/d/15vfUA1ZxHPVW3CC-rGv-EbmmBTuAP_GJ/view?usp=sharing"> <button style={{cursor:"pointer",background:"#4070f4",color:"white",border:"none"}} id="btnresume">Resume</button></a>
        </div>
      </div>
